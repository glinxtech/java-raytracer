...
{
    public static final Material redPlastic = new Material(new Colour(1, 0, 0), new Colour(1, 1, 1), 1);
    public static final Material greenPlastic = new Material(new Colour(0, 1, 0), new Colour(1, 1, 1), 1);
